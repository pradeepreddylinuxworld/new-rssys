...
int mtk_pcm_dl1_mmap(struct snd_pcm_substream *substream,
...
static int mtk_pcm_dl1_fill_silence(struct snd_pcm_substream *substream,
...
static struct snd_pcm_ops mtk_afe_ops = {
	...
	.mmap = mtk_pcm_dl1_mmap,
	.fill_silence = mtk_pcm_dl1_fill_silence,
	.page = mtk_pcm_page,
};
