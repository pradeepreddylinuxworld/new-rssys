...
static int mtk_capture_pcm_prepare(struct snd_pcm_substream *substream)
{
	...
	if (mPrepareDone == false) {
...
#if 1//defined(CONFIG_DMIC_TO_AP)
		/*Dmic to AP:Soc_Aud_Digital_Block_ADDA_UL2 start*/
		if (GetMemoryPathEnable(Soc_Aud_Digital_Block_ADDA_UL2) ==
		    false) {
			SetMemoryPathEnable(Soc_Aud_Digital_Block_ADDA_UL2,
					    true);
		...
		/*Dmic to AP:Soc_Aud_Digital_Block_ADDA_UL2 end*/

//#elif defined(CONFIG_DMIC_TO_PMIC)
		/*Dmic to Pmic:Soc_Aud_Digital_Block_ADDA_UL start*/
		...
		/*Dmic to Pmic:Soc_Aud_Digital_Block_ADDA_UL end*/
#endif
