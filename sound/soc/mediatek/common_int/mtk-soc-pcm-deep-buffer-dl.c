...
int mtk_deep_buffer_mmap(struct snd_pcm_substream *substream,
...
static int mtk_deep_buffer_fill_silence(struct snd_pcm_substream *substream,
...
static struct snd_pcm_ops mtk_deep_buffer_dl_ops = {
	...
	.mmap = mtk_deep_buffer_mmap,
	.fill_silence = mtk_deep_buffer_fill_silence,
};
