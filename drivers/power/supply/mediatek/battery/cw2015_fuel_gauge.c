...
0x15,0x7E,0x6B,0x5F,0x4B,0x73,0x4E,0x46,0x4B,0x49,0x49,0x47,0x49,0x43,
0x2B,0x21,0x18,0x10,0x0C,0x0E,0x1C,0x27,0x38,0x47,0x42,0x56,0x0B,0x85,
0x38,0x59,0x54,0x6D,0x80,0x86,0x8B,0x8B,0x40,0x1A,0x6B,0x24,0x08,0x4A,
0x15,0x44,0x7D,0x96,0xA0,0x25,0x4B,0x7D,0x9A,0xB7,0x80,0x86,0x8B,0xCB,
0x2F,0x00,0x64,0xA5,0xB5,0x01,0xF2,0x61
};
...
static const struct of_device_id cw2015_id_of_match[] = {
	{.compatible = "mediatek,cw2015_fgadc"},
	{},
};

static const struct i2c_device_id cw2015_id_table[] = { {CWFG_NAME, 0}, {} };
...
#endif
		.owner	= THIS_MODULE,
		.of_match_table = cw2015_id_of_match,
	},
	.probe		  = cw2015_probe,
...
static int __init cw215_init(void)
{
	...
	if (i2c_add_driver(&cw2015_driver) != 0)
		cw_printk("Failed to register cw2015 i2c driver.\n");
	else
		cw_printk("Success to register cw2015 i2c driver.\n");
