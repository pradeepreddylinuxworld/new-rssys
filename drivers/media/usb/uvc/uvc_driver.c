		...
		struct uvc_streaming *stream)
{
	...
	video_set_drvdata(vdev, stream);
       ...
       uvc_printk(KERN_INFO,"emdoor fix dev->udev->descriptor.idVendor == 0x%x dev->udev->descriptor.idProduct == 0x%x\n",
		       dev->udev->descriptor.idVendor,dev->udev->descriptor.idProduct);
       if (dev->udev->descriptor.idVendor == 0x0bda && dev->udev->descriptor.idProduct == 0x5830)
