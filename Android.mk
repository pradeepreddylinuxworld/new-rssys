...
CONFIG_PATH := $(LOCAL_PATH)/../out/target/product/$(MTK_TARGET_PROJECT)/obj/KERNEL_OBJ/.config
$(shell touch $(CONFIG_PATH))
...
#MTK_DTBIMAGE_DTS := $(addsuffix .dts,$(addprefix $(KERNEL_DIR)/../custom/$(TARGET_BOARD_PLATFORM)/$(MTK_TARGET_PROJECT)/dts/,$(TARGET_BOARD_PLATFORM)))
...
MTK_DTBOIMAGE_DTS := $(addsuffix .dts,$(addprefix $(KERNEL_DIR)/../custom/$(TARGET_BOARD_PLATFORM)/$(MTK_TARGET_PROJECT)/dts/,$(MTK_TARGET_PROJECT)))
