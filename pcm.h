...
{
        pr_err("hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_CHANNELS)->min: %d,  \n", hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_CHANNELS)->min);
...
{
        pr_err("hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_RATE)->min: %d,  \n", hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_RATE)->min);
...
{
        pr_err("hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_PERIOD_SIZE)->min: %d,  \n", hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_PERIOD_SIZE)->min);
...
{
        pr_err("hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_PERIODS)->min: %d,  \n", hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_PERIODS)->min);
...
{
        pr_err("hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_BUFFER_SIZE)->min: %d,  \n", hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_BUFFER_SIZE)->min);
...
{
        pr_err("hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_BUFFER_BYTES)->min: %d,  \n", hw_param_interval_c(p, SNDRV_PCM_HW_PARAM_BUFFER_BYTES)->min);
